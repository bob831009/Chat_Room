...
class MessageObject implements Serializable{
  String message;
  public MessageObject(String tmp_in){
    message = tmp_in;
  }
}
...
public class MyClient extends JFrame implements ActionListener{  
 ...
 public class IncomingReader implements Runnable{
  public void run(){
   ...
   try{
    while (true){
      message_obj = (MessageObject)reader.readObject();
      incoming.append(message_obj.message+'\n');
    }
 ...
 public void actionPerformed(ActionEvent e){
  ...
  //按下送出   
   ...
   {
    try{//送出資料
        MessageObject Send_Object = new MessageObject(outgoing.getText());
        writer.writeObject(Send_Object); 
     //刷新該串流的緩衝。
     writer.flush();         
    }catch(Exception ex ){
